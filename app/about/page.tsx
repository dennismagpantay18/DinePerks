            ...
            <section className="mt-10 space-y-10 text-muted-foreground">
              ...
              <div>
                ...
                <p className="mt-4 leading-7">
                  ...
                  dining hours while giving diners more reasons to explore local
                  food.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-4 leading-7">
                  Many restaurants have empty tables during early and off-peak hours.
                  At the same time, diners are always looking for better value and new
                  places to try. DinePerks connects both sides in a way that benefits
                  everyone.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-4 leading-7">
                  ...
                  windows, and eligibility rules. DinePerks provides the platform
                  that connects diners to those opportunities.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-4 leading-7">
                  We focus on simplicity, fairness, and real results. Restaurants
                  stay in control of their offers, and diners get a clear,
                  straightforward experience without confusion.
                </p>
              </div>
